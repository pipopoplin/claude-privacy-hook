...
Free tier: basic JSONL logging only.
Log rotation, data minimization, SCF metadata, and custom log paths
require Pro tier.
"""
...
def log_event(
    ...
    Args:
        ...
        scf: Optional SCF metadata (ignored in free tier; requires Pro).
    """
    # Free tier: fixed log path (custom paths require Pro)
    ...
    # Free tier: SCF metadata omitted (requires Pro)
